...
# Disk-based cache storing cached data in the './r-memoise' directory
               ...
               tabPanel("Explore database",
                        ...
                        tabBox(
                          ...
                          tabPanel("Study Overview",
                                   fluidRow(
                                     column(12,
                                            withSpinner(DT::dataTableOutput("study_details")
                                            ))
                                   )
                          ),
                          tabPanel("Metadata",
                                   fluidRow(
                                     column(12,
                                            ...
                                            # Box containing a data table for the metadata
                                            box(
...
server <- function(input, output, session) {
  ...
  output$study_details <- DT::renderDataTable({
    req(input$study_select)  # Ensure that a selection has been made
